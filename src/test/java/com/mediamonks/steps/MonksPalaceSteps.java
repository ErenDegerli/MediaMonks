...
public class MonksPalaceSteps {
    ...
    @When("Supplier adds Turkish translation {string} as name")
    public void supplier_adds_Turkish_translation_as_description(String translatedName) {
        logger.info("Adding Turkish translated hotel name and submitting hotel");
        addHotelPage.addTurkishTranslation(translatedName);
